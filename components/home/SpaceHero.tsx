...
const PROJECTS = [
  ...
  { number: "05", title: "cutitaru", href: "/cutitaru" },
] as const;

function ProjectCTA({ reduced }: { reduced: boolean }) {
  return (
    <motion.div
      className="absolute bottom-10 left-1/2 z-10 grid w-full max-w-4xl -translate-x-1/2 grid-cols-1 gap-3 px-4 sm:bottom-12 sm:grid-cols-2 lg:grid-cols-3 xl:max-w-5xl xl:grid-cols-5 sm:px-0"
